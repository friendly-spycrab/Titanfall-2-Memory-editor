...
void function FreeFall_Main( entity player )
{
	...
	thread PlayFPSAnimTeleportShowProxy( player, "pt_s2s_widowfall_02", "", node, "REF", ViewConeSmall )
...
void function FreeFall_PlayerLands( entity player, entity land )
{
	...
	player.SetAnimNearZ( 4 )
	thread PlayFPSAnimShowProxy( player, "pt_s2s_lifeboats_land", "", land, "REF", ViewConeZero, 0 )
...
{
	player.ClearAnimNearZ()
	waitthread PlayFPSAnimShowProxy( player, "pt_s2s_end_fight_knockback", "", land, "REF", ViewConeZero, 0 )
...
void function Fastball_1_Main( entity player )
{
	...
	SetFastballAnims( "bt_s2s_post_jump_briefing_2_fastball", "bt_s2s_post_jump_fastball_idle", "bt_s2s_post_jump_fastball_end", "", "pt_s2s_fastball_throw_end" )
	...
	thread PlayFPSAnimShowProxy( player, "pt_s2s_lifeboats_land", "" , node, "REF", ViewConeSmall, blendTime, 0.2 )
...
void function Reunited_AnimSetup( entity player )
{
	...
	string animPOV = ""// "pt_pov_joystick_idle"
...
void function BT_Tackle_Main( entity player )
{
	...
	//waitthread PlayFPSAnimShowProxy( player, "pt_s2s_viper_returns_start", "" , node, "REF", ViewConeTight )//, blendTime )
	...
	thread PlayFPSAnimShowProxy( player, "pt_s2s_viper_returns_middle", "" , node, "REF", ViewConeTight, DEFAULT_SCRIPTED_ANIMATION_BLEND_TIME )
...
/*	FirstPersonSequenceStruct sequence
	...
	waitthread PlayFPSAnimShowProxy( player, "pt_s2s_viper_returns_end", "" , node, "REF", ViewConeTight, 0 )
...
void function HackKnockback( entity bt, entity player, entity pNode )
{
	...
	player.SetParent( land, "REF", false, blendTime )
	thread PlayFPSAnimShowProxy( player, "pt_s2s_end_fight_knockback_02", "", land, "REF", ViewConeSmall, 0.0 )
	...
	//thread FirstPersonSequence( sequence, player, pNode )
	thread PlayFPSAnimShowProxy( player, "pt_s2s_sphere_player_protect", "", pNode, "REF", ViewConeSmall, 0.0 )
